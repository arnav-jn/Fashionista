...
def api_currenttrends():
    if 'tshirts' in request.args:
        ...
        dataset_csv = pd.read_csv('csv-data/tshirts/tshirts_csv_final.csv', names=colnames, delimiter=',',
        ...
        return render_template("website_currenttrends_tshirts.html", images_path=images_path, Prod=Prod, Prod2=Prod2,
                               Prod3=Prod3, top1_name=top1_name, top1_description=top1_description,
                               top1_score=top1_score, bottom1_name=bottom1_name,
                               bottom1_description=bottom1_description, bottom1_score=bottom1_score)
    if 'dresses' in request.args:
        ...
        colnames = ['sno', 'URL', 'id', 'desc', 'stars', 'num_ratings', 'num_reviews', 'reviews', 'vader_score',
                    'final_score']
        reqdcolnames = ['id', 'stars', 'desc', 'URL', 'final_score']
        dataset_csv = pd.read_csv('csv-data/dress/dresses_csv_final.csv', names=colnames, delimiter=',',
                                  error_bad_lines=False,
                                  header=None, usecols=reqdcolnames, na_values=" NaN")
        dataset_csv = dataset_csv.dropna()
        dataset_csv2 = dataset_csv.sort_values(by='final_score', ascending=False)
        ...
        data.Prod = json.loads(e)
        Prod = data.Prod
        return render_template("website_currenttrends.html", images_path=images_path, Prod=Prod, top1_name=top1_name,
                               top1_description=top1_description, top1_score=top1_score, bottom1_name=bottom1_name,
                               bottom1_description=bottom1_description, bottom1_score=bottom1_score)
    if 'skirts' in request.args:
        ...
        colnames = ['sno', 'URL', 'id', 'desc', 'stars', 'num_ratings', 'num_reviews', 'reviews', 'vader_score',
                    'final_score']
        reqdcolnames = ['id', 'stars', 'desc', 'URL', 'final_score']
        dataset_csv = pd.read_csv('csv-data/skirt/skirts_csv_final.csv', names=colnames, delimiter=',',
                                  error_bad_lines=False,
                                  header=None, usecols=reqdcolnames, na_values=" NaN")
        dataset_csv = dataset_csv.dropna()
        dataset_csv2 = dataset_csv.sort_values(by='final_score', ascending=False)
